      ...
      >
        ...
        >
          <View className="w-full max-w-[420px] self-center flex-1 justify-between">
            {/* Top Area: Navigation, Header, Form */}
            <View className="w-full">
              <BackButton />

              <View className="my-4">
                <Text className="text-[28px] font-black text-[#AF2219] leading-tight">
                  Let&apos;s reset your password
                </Text>
                <Text className="text-stone-600 text-xs mt-2 leading-relaxed font-medium">
              ...
              {isSent ? (
                <View className="bg-[#AF221915] border border-[#A13024]/30 rounded-2xl p-5 gap-3 mt-2">
                ...
                <View className="w-full gap-4 mt-1">
