    ...
    <ScreenContainer className="px-4 pt-2">
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 32 }}>
        ...
        <View className="py-3 mb-2 flex-row justify-between items-center">
          <View>
            <Text className="text-xs font-bold uppercase tracking-wider text-muted">Player Status</Text>
            <Text className="text-2xl font-black text-foreground">Profile & Duo</Text>
          </View>
        </View>

        {/* Profile Card */}
        <View className="bg-surface rounded-3xl p-5 border border-border mb-5">
          <View className="flex-row items-center gap-4 mb-4">
            <View className="h-16 w-16 rounded-2xl bg-canvas border border-border items-center justify-center">
              <Text className="text-xl font-black text-foreground">JP</Text>
            </View>
            <View className="flex-1">
              ...
              <Text className="text-xs text-muted">Co-op Partner: {profile?.partner_name ?? "Kira"}</Text>
            </View>
          </View>
          ...
          <View>
            <View className="flex-row justify-between mb-1.5">
              <Text className="text-xs font-bold text-muted">EXP Progression</Text>
              <Text className="text-xs font-bold text-foreground tabular-nums">
        ...
        <View className="bg-surface rounded-2xl border border-border overflow-hidden mb-5">
          ...
          {showMechanics && (
            <View className="p-4 bg-canvas border-b border-border">
              <Text className="text-xs font-extrabold uppercase text-primary mb-1">
          ...
          <View className="p-4 flex-row items-center justify-between">
            ...
            <View className="bg-success/15 px-2 py-0.5 rounded-md">
              <Text className="text-[10px] font-bold text-success">READY</Text>
            </View>
          </View>
        </View>
        ...
        <View className="items-center py-4">
          <Text className="text-xs font-bold text-muted">Traki v0.1.0 • 16-Bit Gamified Financial Tracker</Text>
        </View>
      </ScrollView>
    </ScreenContainer>
  );
